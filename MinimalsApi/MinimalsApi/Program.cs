...
builder.Services.AddDbContext<MeuDbContexto>(options =>
{
    options.UseMySql(
...
app.MapPost("/admonistradores/login", ([FromBody] LoginDTO loginDTO, IAdministradorServico administradorServico) =>
{
...
app.MapGet("/admonistradores", ([FromQuery] int? pagina, IAdministradorServico administradorServico) =>
{
...
app.MapGet("/admonistradores/{id}", ([FromRoute] int id, IAdministradorServico administradorServico) =>
{
    var administrador = administradorServico.BuscarPorId(id); // Certifique-se de que esse método existe
...
app.MapPost("/admonistradores", ([FromBody] AdministradorDTO administradorDTO, IAdministradorServico administradorServico) =>
{
    ...
    return Results.Created($"/administradorDTO/{administrador.Id}", new AdministradorModelViews
    {
        Id = administrador.Id,
        Email = administrador.Email,
        Perfil = administrador.Perfil
